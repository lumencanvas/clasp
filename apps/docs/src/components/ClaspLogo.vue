...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300" :width="size" :height="size">
    <defs>
      <filter id="docs-logo-rough" x="-5%" y="-5%" width="110%" height="110%">
    ...
    <!-- Connection lines -->
    <g :stroke="color" stroke-width="6" stroke-linecap="round" filter="url(#docs-logo-rough)">
    ...
    <!-- Center node -->
    <g filter="url(#docs-logo-rough)">
      <circle cx="150" cy="150" r="28" fill="#1a1a1a" :stroke="color" stroke-width="8"/>
      <circle cx="150" cy="150" r="10" :fill="color"/>
    </g>

    <!-- Accent -->
    <g opacity="0.9" filter="url(#docs-logo-rough)">
