/**
 * SignalFlow client implementation
 */
...
import { SignalFlowBuilder } from './builder';
...
export class SignalFlow {
   ...
   * Create a builder
   */
  static builder(url: string): SignalFlowBuilder {
    return new SignalFlowBuilder(url);
  }
  ...
  private handleMessage(message: Message): void {
    switch (message.type) {
      ...
      case 'ERROR':
        console.error('SignalFlow error:', message);
        break;
    }
  }
