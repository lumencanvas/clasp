"""Tests for SignalFlow client."""

import pytest
from signalflow import SignalFlow, SignalFlowBuilder
from signalflow.client import SignalFlowError


class TestSignalFlowBuilder:
    """Test SignalFlowBuilder class."""

    def test_builder_creation(self):
        builder = SignalFlowBuilder(url="ws://localhost:7330")
    ...
    def test_builder_chaining(self):
        builder = (
            SignalFlowBuilder(url="ws://localhost:7330")
...
class TestSignalFlow:
    """Test SignalFlow client class."""

    def test_client_creation(self):
        client = SignalFlow("ws://localhost:7330")
    ...
    def test_client_builder_method(self):
        builder = SignalFlow.builder("ws://localhost:7330")
        assert isinstance(builder, SignalFlowBuilder)
        assert builder.url == "ws://localhost:7330"
...
class TestSignalFlowError:
    """Test SignalFlowError exception."""

    def test_error_creation(self):
        error = SignalFlowError("Test error message")
        assert str(error) == "Test error message"

    def test_error_inheritance(self):
        error = SignalFlowError("Error")
