use clasp_core::address::{glob_match, Pattern};
...
fn main() {
    ...
    println!(
        "glob_match('{}', '{}') = {}",
        pattern_str, address_single, match_single
    );
    println!(
        "glob_match('{}', '{}') = {}",
        pattern_str, address_multi, match_multi
    );
    println!();
    ...
    println!(
        "Pattern struct matches single: {}",
        pattern.matches(address_single)
    );
    println!(
        "Pattern struct matches multi: {}",
        pattern.matches(address_multi)
    );
    println!();
