...
impl OscBridge {
    ...
    fn osc_to_signalflow(&self, msg: &OscMessage) -> Option<Message> {
    ...
    fn signalflow_to_osc(&self, msg: &Message) -> Option<OscPacket> {
        match msg {
            Message::Set(set) => {
...
impl Bridge for OscBridge {
    ...
    async fn send(&self, message: Message) -> Result<()> {
        ...
        if let Some(packet) = self.signalflow_to_osc(&message) {
    ...
    match packet {
        ...
        OscPacket::Bundle(bundle) => {
            ...
            if messages.is_empty() {
                ...
                Some(vec![Message::Bundle(signalflow_core::BundleMessage {
