//! SignalFlow Core
//!
//! Core types, encoding, and protocol primitives for SignalFlow v2.
//!
//! This crate provides:
...
pub const WS_SUBPROTOCOL: &str = "signalflow.v2";

/// mDNS service type
pub const MDNS_SERVICE_TYPE: &str = "_signalflow._tcp.local.";
