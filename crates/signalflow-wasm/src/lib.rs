...
impl SignalFlowWasm {
    ...
    pub fn unsubscribe(&self, id: u32) {
        let msg = Message::Unsubscribe(signalflow_core::UnsubscribeMessage { id });
        self.send_message(&msg);
    }
    ...
    pub fn emit(&self, address: &str, payload: JsValue) {
        ...
        let msg = Message::Publish(signalflow_core::PublishMessage {
            address: address.to_string(),
            signal: Some(signalflow_core::SignalType::Event),
            value: None,
