---
title: "CLASP Architecture"
description: "This document explains how CLASP is structured and when to use each component."
section: root
order: 1
---
# CLASP Architecture
...
```toml
[dependencies]
clasp-transport = { version = "3.5", features = ["websocket"] }
# Or for all transports:
clasp-transport = { version = "3.5", features = ["full"] }
```
...
```toml
[dependencies]
clasp-router = { version = "3.5", features = ["websocket"] }
```
...
```toml
[dependencies]
clasp-embedded = { version = "3.5", features = ["client"] }
# Or for server mode:
clasp-embedded = { version = "3.5", features = ["server"] }
```
