...
description: "How CLASP capability tokens support delegation chains with scope attenuation, enabling decentralized authorization without a central authority."
section: explanation
order: 3
---
