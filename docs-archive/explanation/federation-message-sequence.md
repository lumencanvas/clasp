---
title: "Federation Message Sequence"
description: "Detailed protocol sequences for CLASP router-to-router federation, covering the handshake, initial sync, steady-state forwarding, and revision vector..."
section: explanation
order: 6
---
