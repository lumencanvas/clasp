---
title: "Getting Started with CLASP"
description: "CLASP (Creative Low-Latency Application Streaming Protocol) is a universal protocol bridge for creative applications. This guide will help you get up and..."
...
[dependencies]
clasp-core = "3.5"
clasp-bridge = { version = "3.5", features = ["osc", "mqtt"] }
```
...
- [Concepts](../explanation/README.md) - Understand addresses, signals, and routing
- [Tutorials](../tutorials/README.md) - Step-by-step learning guides
- [How-To Guides](../how-to/README.md) - Task-oriented procedures
