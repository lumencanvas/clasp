---
title: "Router and Protocol Connection Setup Guide"
description: "This guide explains how to set up CLASP routers and protocol connections."
section: guides
order: 1
---
...
See [Embed a Router](../how-to/advanced/embed-router.md) for code examples.
