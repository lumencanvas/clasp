...
description: "This guide explains how to integrate MQTT (Message Queuing Telemetry Transport) with CLASP."
section: guides
order: 2
---
...
```toml
[dependencies]
clasp-router = { version = "3.5", features = ["mqtt-server"] }
```
...
- [MQTT Bridge Reference](../../reference/bridges/mqtt.md) - Full bridge reference
