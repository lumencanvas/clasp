---
title: "Enable TLS"
description: "Secure CLASP connections with TLS encryption."
section: how-to
order: 2
---
# Enable TLS
...
// Connect with TLS
const client = await new ClaspBuilder('wss://clasp.example.com:7330');
...
# Connect with TLS
client = await ClaspBuilder('wss://clasp.example.com:7330')
