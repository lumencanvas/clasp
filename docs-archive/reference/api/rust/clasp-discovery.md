---
title: "clasp-discovery (Rust)"
description: "Discovery mechanisms for finding CLASP routers."
section: reference
order: 4
---
...
clasp-discovery = { version = "3.5", features = ["full"] }

# Individual methods
clasp-discovery = { version = "3.5", features = ["mdns", "udp"] }
```
