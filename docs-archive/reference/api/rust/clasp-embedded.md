---
title: "clasp-embedded (Rust)"
description: "No-std CLASP client for embedded systems."
section: reference
order: 5
---
# clasp-embedded (Rust)
...
```toml
[dependencies]
clasp-embedded = { version = "3.5", features = ["cortex-m"] }
```
...
```toml
[dependencies]
clasp-embedded = { version = "3.5", features = ["riscv"] }
```
...
```toml
[dependencies]
clasp-embedded = { version = "3.5", features = ["esp32"] }
```
