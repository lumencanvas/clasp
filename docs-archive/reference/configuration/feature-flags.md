---
title: "Feature Flags"
description: "Cargo feature flags for CLASP Rust crates."
section: reference
order: 2
---
# Feature Flags
...
```toml
[dependencies]
clasp-core = { version = "3.5", features = ["..."] }
```
...
```toml
clasp-core = { version = "3.5", default-features = false }
```
...
```toml
[dependencies]
clasp-client = { version = "3.5", features = ["..."] }
```
...
```toml
clasp-client = { version = "3.5", default-features = false, features = ["websocket"] }
```

### Full Client

```toml
clasp-client = { version = "3.5", features = ["quic", "discovery"] }
```
...
```toml
[dependencies]
clasp-router = { version = "3.5", features = ["..."] }
```
...
```toml
[dependencies]
clasp-bridge = { version = "3.5", features = ["..."] }
```
...
```toml
clasp-bridge = { version = "3.5", features = ["full"] }
```
...
```toml
[dependencies]
clasp-transport = { version = "3.5", features = ["..."] }
```
...
```toml
[dependencies]
clasp-discovery = { version = "3.5", features = ["..."] }
```
...
```toml
[dependencies]
clasp-embedded = { version = "3.5", default-features = false, features = ["..."] }
```
...
```toml
clasp-embedded = { version = "3.5", default-features = false, features = ["esp32"] }
```
