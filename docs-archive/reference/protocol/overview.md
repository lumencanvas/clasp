...
description: "CLASP (Creative Low-Latency Application Streaming Protocol) is a modern protocol designed for real-time creative applications. This document describes the..."
section: reference
order: 1
---
# Protocol Overview
