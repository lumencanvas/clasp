---
title: "Sensor to Visualization Tutorial"
description: "Create a pipeline from IoT sensors to a visualization application."
section: tutorials
order: 3
---
...
- Maps MQTT topics to CLASP addresses by adding a `/mqtt/` prefix and leading slash: `sensors/room1/temp` → `/mqtt/sensors/room1/temp`

The `/mqtt/` prefix is added automatically by the MQTT bridge so that CLASP subscribers can distinguish MQTT-sourced data from native CLASP signals. This prefix is configurable with `--namespace`.
    ...
    def on_sensor(data, address):
        ...
        if sensor_type in thresholds:
            ...
            if value < limits['min'] or value > limits['max']:
                ...
                client.emit('/alerts/sensor', alert)
