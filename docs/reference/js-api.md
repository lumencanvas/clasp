...
Complete API reference for the `@clasp-to/core` package (v4.1.0+). This covers the `ClaspBuilder` and `Clasp` classes, all method signatures, and type definitions. For usage patterns and examples, see the [JavaScript SDK guide](../sdk/javascript.md).
